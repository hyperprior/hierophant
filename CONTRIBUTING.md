To get started with development, you'll need to set up your local environment. We've provided a Makefile to automate this process. Simply clone the repository, navigate to the project directory, and run:
